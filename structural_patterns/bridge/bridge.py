...
class Abstraction:
    ...
    class hierarchies. It maintains a reference to an object of the Implementation
...
class Implementation(ABC):
    ...
    different. Typically the Implementation interface provides only primitive operations, while 
    the Abstraction defines high level operations based on those primitives.
    """
...
if __name__ == "__main__":
    """
    The client code should be able to work with any pre-configured abstraction-implementation
    combination.
    """
